...
void 
Bmc_Dump_WriteProblem2(const BeEnc_ptr be_enc, 
                const Be_Cnf_ptr cnf, 
                Prop_ptr prop, 
                const int k, const int loop, 
                const Bmc_DumpType dump_type,
...
int 
Bmc_Dump_DimacsProblemFilename2(const BeEnc_ptr be_enc, 
                     const Be_Cnf_ptr cnf,
                     const char* filename,  
                     const int k,
                     const int write_property,
...
Bmc_Dump_DimacsProblem(const BeEnc_ptr be_enc, 
                 const Be_Cnf_ptr cnf,
                 const int k, const int step_phy_index,
                 FILE* dimacsfile);

void 
Bmc_Dump_DimacsProblem2(const BeEnc_ptr be_enc, 
                 const Be_Cnf_ptr cnf,
