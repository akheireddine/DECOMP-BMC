...
Bmc_Model_GetUnrolling(const BeFsm_ptr be_fsm,
                       const int j, const int k, const int step_phy_index);
...
*/
be_ptr
Bmc_Model_GetPathNoInit(const BeFsm_ptr be_fsm, const int k, const int step_phy_index);
...
*/
be_ptr
Bmc_Model_GetPathWithInit(const BeFsm_ptr be_fsm, const int k, int * step_phy_index);
